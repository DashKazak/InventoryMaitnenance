...
namespace InventoryMaintenance
{
    ...
    {
        private const string Path = @"C:\Users\crew\OneDrive\Desktop\SCHOOL\ASP.NET DEV\Projects\InventoryMaintenance\InventoryMaintenance\InventoryItems.xml";
        ...
        public static List<InvItem> GetItems()
        {
            ...
            if (xmlIn.ReadToDescendant("Item"))
            {
                ...
                do
                {
                    ...
                    item.ItemNo = xmlIn.ReadElementContentAsString();
                    item.Description = xmlIn.ReadElementContentAsString();
                    item.Price = xmlIn.ReadElementContentAsString();
                    items.Add(item);
                }
